...
const ourMissionImd = {
	...
	description2:
		"Integrate data and knowledge from diverse disciplines relevant to glycobiology.",
							...
							<Row>
								<Col xs={12} md={6}>
									<p>
										...
										integrating diverse kinds of information, including
										glycomics, genomics, proteomics (and glycoproteomics), cell
								...
								<Col xs={12} md={6}>
									<p>
										...
										allows for exploring this data by performing unique searches
										that cannot be executed in any of the existing databases
										alone.
									</p>
								</Col>
							</Row>
						...
						<Col xs={12} lg={4}>
							...
							<div className="about-item card text-center mb-2">
								<p>
									...
									and data to address specific questions in glycoscience.
								</p>
							</div>
						</Col>
						<Col xs={12} lg={4}>
							...
							<div class="about-item card text-center mb-2">
								<p>
									...
									from disparate databases and websites.
								</p>
							</div>
						</Col>
						<Col xs={12} lg={4}>
				...
				<Container maxWidth="lg" className="gg-container">
					<Row>
						<Col xs={12} md={12} lg={6}>
							...
							<p>
								An open, standardized environment for independent development
								and integration of additional research tools by other
								investigators.
							</p>
							<p>
								More than 15 investigators in four countries play key roles in
								the project.
							</p>
							<p>
								Two years of organized discussion and planning involving nearly
								100 investigators.
							</p>
						</Col>
						<Col
						...
						<Col sm={6}>
							...
							<div className="about-item card text-center mb-3 border-blue">
								<p>
									...
									transformation of data to glycobiology knowledge, and insight.
								</p>
							</div>
						</Col>
						<Col sm={6}>
						...
						<Col sm={6}>
							...
							<div class="about-item card text-center mb-3 text-blue">
								<p>
									...
									biological knowledge from diverse disciplines.
								</p>
							</div>
						</Col>
						<Col sm={6}>
							...
							<div class="about-item card text-center mb-3 border-blue">
								<p>
									...
									to explore data from diverse domains in the context of
									glycoscience.
								</p>
							</div>
						</Col>
