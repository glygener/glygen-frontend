...
/**
 * Biological Process Node display component.
 */
const BiologicalProcessNodeDisplay = (props) => {
  ...
  return (
    <>
      <Dialog
        open={props.nodeType === "biological-process"}
        classes={{
          paper: "alert-dialog",
        }}
        style={{ margin: 40 }}
      ...
      >
        <div className="gf-content-div">
          <h5 className="sups-dialog-title" style={{ width: '800px' }}>{"Biological Process : " + name}</h5>
          <div
          ...
          >
            ...
            <div style={{ padding: '20px', overflow: 'scroll', content: 'center', maxHeight: '300px', width: '720px' }}>
              {props.nodeType === "biological-process" && <div>
                <div>
                  <div>
                    <strong>
                      {"Name"}:{" "}
...
export default BiologicalProcessNodeDisplay;

BiologicalProcessNodeDisplay.propTypes = {
