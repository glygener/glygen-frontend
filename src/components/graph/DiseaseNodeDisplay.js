...
/**
 * Disease Node display component.
 */
const DiseaseNodeDisplay = (props) => {
    ...
    <>
      ...
      >
        <div className="gf-content-div">
          <h5 className="sups-dialog-title" style={{ width: '800px' }}>{"Disease Name : " + name}</h5>
          <div
...
export default DiseaseNodeDisplay;

DiseaseNodeDisplay.propTypes = {
