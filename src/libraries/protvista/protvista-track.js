var ProtvistaTrack = (function (exports,d3,ProtvistaZoomable) {
  ...
  function () {
    ...
    _createClass(FeatureShape, [{
      ...
      value: function _rectangle() {
        return 'M0,0' + 'L' + this._ftWidth + ',0' + 'L' + this._ftWidth + ',' + this._ftHeight + 'L0,' + this._ftHeight + 'Z';
      }
    }, {
      key: "_roundRectangle",
      value: function _roundRectangle() {
        var radius = 6;
        return 'M' + radius + ',0' + 'h' + (this._ftWidth - 2 * radius) + ',0' + "a" + radius + "," + radius + " 0 0 1 " + radius + "," + radius + "v" + (this._ftHeight - 2 * radius) + "a" + radius + "," + radius + " 0 0 1 " + -radius + "," + radius + "h" + (2 * radius - this._ftWidth) + "a" + radius + "," + radius + " 0 0 1 " + -radius + "," + -radius + "v" + (2 * radius - this._ftHeight) + "a" + radius + "," + radius + " 0 0 1 " + radius + "," + -radius + 'Z';
      }
    }, {
      key: "_bridge",
      value: function _bridge() {
        if (this._ftLength !== 1) {
          return 'M0,' + this._ftHeight + 'L0,0' + 'L' + this._ftWidth + ',0' + 'L' + this._ftWidth + ',' + this._ftHeight + 'L' + this._ftWidth + ',2' + 'L0,2Z';
        } else {
          return 'M0,' + this._ftHeight + 'L0,' + this._ftHeight / 2 + 'L' + this._ftWidth / 2 + ',' + this._ftHeight / 2 + 'L' + this._ftWidth / 2 + ',0' + 'L' + this._ftWidth / 2 + ',' + this._ftHeight / 2 + 'L' + this._ftWidth + ',' + this._ftHeight / 2 + 'L' + this._ftWidth + ',' + this._ftHeight + 'Z';
        }
      }
    }, {
      key: "_getMiddleLine",
      ...
      value: function _diamond() {
        ...
        var shape = 'M' + m + ',0' + 'L' + (m + centerx) + ',' + centerx + 'L' + m + ',' + symbolSize + 'L' + (m - centerx) + ',' + centerx;
        return this._ftLength !== 1 ? shape + this._getMiddleLine(centerx, this._ftWidth) : shape + 'Z';
      }
    }, {
      key: "_chevron",
      value: function _chevron() {
        var m = this._ftWidth / 2;
        var centerx = symbolSize / 2;
        var shape = 'M' + m + ',' + centerx + 'L' + (centerx + m) + ',0' + 'L' + (centerx + m) + ',' + centerx + 'L' + m + ',' + symbolSize + 'L' + (-centerx + m) + ',' + centerx + 'L' + (-centerx + m) + ',0';
        return this._ftLength !== 1 ? shape + 'L' + m + ',' + centerx + this._getMiddleLine(centerx, this._ftWidth) + 'Z' : shape + 'Z';
      }
    }, {
      key: "_catFace",
      value: function _catFace() {
        ...
        var m = this._ftWidth / 2;
        var shape = 'M' + (-centerx + m) + ',0' + 'L' + (-centerx + m) + ',' + 6 * step + 'L' + (-2 * step + m) + ',' + symbolSize + 'L' + (2 * step + m) + ',' + symbolSize + 'L' + (centerx + m) + ',' + 6 * step + 'L' + (centerx + m) + ',0' + 'L' + (2 * step + m) + ',' + 4 * step + 'L' + (-2 * step + m) + ',' + 4 * step;
        return this._ftLength !== 1 ? shape + 'M' + m + ',0' + this._getMiddleLine(centerx, this._ftWidth) + 'Z' : shape + 'Z';
      }
    }, {
      key: "_triangle",
      value: function _triangle() {
        var centerx = symbolSize / 2;
        var m = this._ftWidth / 2;
        var shape = 'M' + m + ',0' + 'L' + (centerx + m) + ',' + symbolSize + 'L' + (-centerx + m) + ',' + symbolSize;
        return this._ftLength !== 1 ? shape + 'L' + m + ',0' + this._getMiddleLine(centerx, this._ftWidth) + 'Z' : shape + 'Z';
      }
    }, {
      key: "_wave",
      value: function _wave() {
        ...
        var ry = symbolSize / 2;
        var m = this._ftWidth / 2;
        var shape = 'M' + (-symbolSize / 2 + m) + ',' + ry + "A" + rx + "," + ry + " 0 1,1 " + m + "," + ry + "A" + rx + "," + ry + " 0 1,0 " + (symbolSize / 2 + m) + ',' + ry;
      ...
      value: function _getPolygon(sidesNumber) {
        ...
        for (var i = 0; i < sidesNumber; i++) {
          polygon += r * Math.cos(2 * Math.PI * i / sidesNumber) + m + ',' + (r * Math.sin(2 * Math.PI * i / sidesNumber) + r) + ' ';
        }

        return this._ftLength !== 1 ? polygon + ' ' + (r * Math.cos(0) + m) + ',' + (r * Math.sin(0) + r) + ' ' + this._getMiddleLine(r, this._ftWidth) + 'Z' : polygon + 'Z';
      }
    }, {
      key: "_hexagon",
      ...
      value: function _circle() {
        ...
        var shape = "M" + m + ",0" + "A" + r + "," + r + " 0 1,1 " + m + "," + symbolSize + "A" + r + "," + r + " 0 1,1 " + m + ",0";
      ...
      value: function _arrow() {
        var step = symbolSize / 10;
        var m = this._ftWidth / 2;
        var shape = 'M' + m + ',0' + 'L' + (-step + m) + ',0' + 'L' + (-5 * step + m) + ',' + 4 * step + 'L' + (-step + m) + ',' + this._ftHeight + 'L' + m + ',' + this._ftHeight + 'L' + (4 * step + m) + ',' + 4 * step;
        return this._ftLength !== 1 ? shape + 'L' + m + ',0' + this._getMiddleLine(symbolSize / 2, this._ftWidth) + 'Z' : shape + 'Z';
      }
    }, {
      key: "_doubleBar",
      value: function _doubleBar() {
        var m = this._ftWidth / 2;
        var centerx = symbolSize / 2;
        var shape = 'M' + m + ',0' + 'L' + (-centerx + m) + ',' + symbolSize + 'L' + m + ',' + symbolSize + 'L' + (centerx + m) + ',0';
        return this._ftLength !== 1 ? shape + 'L' + m + ',0' + this._getMiddleLine(symbolSize / 2, this._ftWidth) + 'Z' : shape + 'Z';
      }
    }, {
      key: "_getBrokenEnd",
      value: function _getBrokenEnd() {
        ...
        return 'L' + (this._ftWidth - qh) + ',' + qh + 'L' + this._ftWidth + ',' + 2 * qh + 'L' + (this._ftWidth - qh) + ',' + 3 * qh + 'L' + this._ftWidth + ',' + this._ftHeight;
      }
    }, {
      key: "_getBrokenStart",
      ...
      value: function _discontinuosStart() {
        return 'M0,0' + 'L' + this._ftWidth + ',0' + 'L' + this._ftWidth + ',' + this._ftHeight + 'L0,' + this._ftHeight + this._getBrokenStart() + 'Z';
      }
    }, {
      key: "_discontinuos",
      value: function _discontinuos() {
        return 'M0,0' + 'L' + this._ftWidth + ',0' + this._getBrokenEnd() + 'L0,' + this._ftHeight + this._getBrokenStart() + 'Z';
      }
    }, {
      key: "_discontinuosEnd",
      value: function _discontinuosEnd() {
        return 'M0,0' + 'L' + this._ftWidth + ',0' + this._getBrokenEnd() + 'L0,' + this._ftHeight + 'Z';
      }
    }], [{
      key: "isContinuous",
  ...
  function (_DefaultLayout) {
    ...
    function NonOverlappingLayout(options) {
      ...
      _this2 = _possibleConstructorReturn(this, _getPrototypeOf(NonOverlappingLayout).call(this, options));
      _this2._rowHeight = 0;
      _this2._rows = [];
  ...
  function (_ProtvistaZoomable) {
    ...
    function ProtvistaTrack() {
      ...
      return _possibleConstructorReturn(this, _getPrototypeOf(ProtvistaTrack).apply(this, arguments));
    }

    _createClass(ProtvistaTrack, [{
      key: "getLayout",
      value: function getLayout(data) {
        if (String(this.getAttribute("layout")).toLowerCase() === "non-overlapping") return new NonOverlappingLayout({
      ...
      value: function connectedCallback() {
        ...
        _get(_getPrototypeOf(ProtvistaTrack.prototype), "connectedCallback", this).call(this);
      ...
      value: function normalizeLocations(data) {
        return data.map(function (obj) {
          ...
          return locations ? obj : Object.assign(obj, {
            locations: [{
              fragments: [{
                start: start,
                end: end
      ...
      value: function _createTrack() {
        ...
        d3.select(this).html("");
        this.svg = d3.select(this).append("div").style("line-height", 0).append("svg").attr("width", this.width).attr("height", this._height);
        this.highlighted = this.svg.append("rect").attr("class", "highlighted").attr("fill", "rgba(255, 235, 59, 0.8)") // .attr('stroke', 'black')
        .attr("height", this._height);
        this.seq_g = this.svg.append("g").attr("class", "sequence-features").attr("transform", "translate(0 ," + this.margin.top + ")");
      ...
      value: function _createFeatures() {
        ...
        .enter().append("path").attr("class", "feature").attr("tooltip-trigger", "true").attr("d", function (f) {
          return _this2._featureShape.getFeatureShape(_this2.getSingleBaseWidth(), _this2._layoutObj.getFeatureHeight(f), f.end ? f.end - f.start + 1 : 1, _this2._getShape(f.feature));
        }).attr("transform", function (f) {
          return "translate(" + _this2.getXFromSeqPosition(f.start) + "," + (_this2.margin.top + _this2._layoutObj.getFeatureYPos(f.feature)) + ")";
      ...
      value: function createTooltip(e, d) {
        var closeable = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
        ...
        tooltip.title = "".concat(d.feature.type, " ").concat(d.start, "-").concat(d.end);
        ...
        var tooltipPosition = d3.select(tooltip).node().getBoundingClientRect();
      ...
      value: function removeAllTooltips() {
        document.querySelectorAll("protvista-tooltip").forEach(function (tooltip) {
        ...
        if (this.xScale && this.seq_g) {
          this.features = this.seq_g.selectAll("path.feature").data(this._data.reduce(function (acc, f) {
            return acc.concat(f.locations.reduce(function (acc2, e) {
              return acc2.concat(e.fragments.map(function (loc) {
                return Object.assign({}, loc, {
                  feature: f
                });
              }));
          ...
          this.features.attr("d", function (f) {
            return _this3._featureShape.getFeatureShape(_this3.getSingleBaseWidth(), _this3._layoutObj.getFeatureHeight(f), f.end ? f.end - f.start + 1 : 1, _this3._getShape(f.feature));
          }).attr("transform", function (f) {
            return "translate(" + _this3.getXFromSeqPosition(f.start) + "," + (_this3.margin.top + _this3._layoutObj.getFeatureYPos(f.feature)) + ")";
          });
      ...
      value: function _updateHighlight() {
        if (Number.isInteger(this._highlightstart) && Number.isInteger(this._highlightend)) {
          this.highlighted.attr("x", this.getXFromSeqPosition(this._highlightstart)).style("opacity", 0.3).attr("width", this.getSingleBaseWidth() * (this._highlightend - this._highlightstart + 1));
        } else {
